    ...
    get: {
      ...
      response: {
        body: {
          ...
          hourly: {
            [tables.weather_data_hour().hour().json]: tables
              .weather_data_hour()
              .hour().validation,

            [tables.weather_data_hour().temperature().json]: tables
              .weather_data_hour()
              .temperature().validation,

            [tables.weather_data_hour().felt_temperature().json]: tables
              .weather_data_hour()
              .felt_temperature().validation,

            [tables.weather_data_hour().fk_sky_state_name().json]: tables
              .weather_data_hour()
              .fk_sky_state_name().validation,

            [tables.weather_data_hour().wind_speed().json]: tables
              .weather_data_hour()
              .wind_speed().validation,

            [tables.weather_data_hour().wind_gust().json]: tables
              .weather_data_hour()
              .wind_gust().validation,

            [tables.weather_data_hour().wind_degree().json]: tables
              .weather_data_hour()
              .wind_degree().validation,

            [tables.weather_data_hour().fk_wind_direction().json]: tables
              .weather_data_hour()
              .fk_wind_direction().validation,

            [tables.weather_data_hour().precipitation_probability().json]:
              tables.weather_data_hour().precipitation_probability().validation,

            [tables.weather_data_hour().humidity().json]: tables
              .weather_data_hour()
              .humidity().validation,

            [tables.weather_data_hour().air_pressure().json]: tables
              .weather_data_hour()
              .air_pressure().validation,
          },
        },
